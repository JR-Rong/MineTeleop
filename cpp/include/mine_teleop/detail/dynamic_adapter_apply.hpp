...
using DynamicAdapterApplyV2Fn = int (*)(int, double, double, const double*, int, void*);
...
[[nodiscard]] DynamicAdapterApplyV2Outcome invoke_dynamic_adapter_apply_v2(
    DynamicAdapterApplyV2Fn apply_v2, int target_gear, double target_vx, double target_ax,
