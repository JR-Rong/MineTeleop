...
"""
    ...
    def test_driver_config_exposes_cloud_ui_and_keyboard_contract(self):
        ...
        self.assertEqual(config.control.keyboard.steering_left, "ARROWLEFT")
        self.assertEqual(config.control.keyboard.steering_right, "ARROWRIGHT")
        self.assertEqual(config.control.keyboard.throttle, "ARROWUP")
        self.assertEqual(config.control.keyboard.brake, "ARROWDOWN")
        self.assertEqual(config.control.keyboard.estop, "E")
