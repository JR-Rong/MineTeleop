...
int mine_teleop_chassis_open_v1(const struct MineTeleopChassisOpenConfigV1* config) {
  (void)config;
  mark_can_initialization();
  return 0;
}

int mine_teleop_chassis_open_v2(const struct MineTeleopChassisOpenConfigV2* config) {
  (void)config;
  mark_can_initialization();
  return 0;
}

int mine_teleop_chassis_open_v3(const struct MineTeleopChassisOpenConfigV3* config) {
  (void)config;
  mark_can_initialization();
  return 0;
}

int mine_teleop_chassis_open_v4(const struct MineTeleopChassisOpenConfigV4* config) {
  (void)config;
  mark_can_initialization();
  return 0;
}
...
int mine_teleop_chassis_apply_state(int target_gear, double target_vx, double target_ax,
...
int mine_teleop_chassis_apply_state_v2(int target_gear, double target_vx, double target_ax,
                                       const double* steering_values, int steering_count,
...
int mine_teleop_chassis_set_stop_context_v1(const struct MineTeleopChassisStopContextV1* context) {
  (void)context;
  return 0;
}
...
int mine_teleop_chassis_read_handshake_status(struct MineTeleopChassisHandshakeStatus* status) {
  (void)status;
  return 0;
}
...
int mine_teleop_chassis_read_can_feedback_v1(struct MineTeleopChassisCanFeedbackV1* feedback) {
  (void)feedback;
  return 0;
}
