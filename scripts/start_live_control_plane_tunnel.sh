...
spawn ssh -p $port -fN -o ExitOnForwardFailure=yes -o ServerAliveInterval=30 -o StrictHostKeyChecking=accept-new -R ${remote_port}:127.0.0.1:${local_port} ${user}@${host}
expect {
